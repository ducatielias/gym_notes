...
function isActiveWorkoutTimerPanelVisible(panelId) {
...
function registerActiveWorkoutTimerPanelBackHandlers() {
    const backNavigation = window.GymNotesBackNavigation;
    if (!backNavigation) return;

    // El registro conserva este orden cuando ambos paneles comparten la
    // prioridad semantica de capa auxiliar.
    backNavigation.register({
        id: 'tabata-panel',
        priority: backNavigation.PRIORITY.AUXILIARY_PANEL,
        canHandle: () => isActiveWorkoutTimerPanelVisible('timer-panel'),
        handle: () => {
    ...
    backNavigation.register({
        id: 'rest-panel',
        priority: backNavigation.PRIORITY.AUXILIARY_PANEL,
        canHandle: () => isActiveWorkoutTimerPanelVisible('descanso-panel'),
        handle: () => {
...
registerActiveWorkoutTimerPanelBackHandlers();
